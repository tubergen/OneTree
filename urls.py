...
urlpatterns = patterns('',
    ...
    url(r'^profile/account/forgetpwd/$', password_reset, {'template_name': 'user/forgot_password.html', 'post_reset_redirect': '/profile/account/forgetpwdsent' }, name='forgot_password'), 
